...
**/
	...
	public int insertUser(User user) {
		...
		if(true)
		throw new RuntimeException("An intentional runtime exception for insertion");
	...
	public User selectUser(int uid) {
		...
		// rolled back
		throw new RuntimeException("An intentional runtime exception for user selection");
	...
	public int updateUser(User user) throws Exception {
		 ...
		 */
		throw new Exception("An intentional checked exception for update user");
	}
